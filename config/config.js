...
module.exports = {
  ...
  DB_URL: `mongodb+srv://${DB_URI}.yrwhz.mongodb.net/${database = 'ProyectoFinal'}?retryWrites=true&w=majority`,

  mongodb: {
    connectTo: (database) =>
      `mongodb+srv://${DB_URI}.yrwhz.mongodb.net/${database}?retryWrites=true&w=majority`
  },
}